...
public class DelegateEntryEditor : VisualElement
{
    ...
    public DelegateEntryEditor(ExposedDelegateEditor exposedDelegateEditor, DelegateEntry delegateEntry)
    {
        ...
        if(delegateEntry.TargetGO != exposedDelegateEditor.utilityAIActionEditor.utilityAIAgentEditor.utilityAIAgent.gameObject)
        {
            delegateEntry.TargetGO = exposedDelegateEditor.utilityAIActionEditor.utilityAIAgentEditor.utilityAIAgent.gameObject;
        }
